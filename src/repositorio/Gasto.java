...
public class Gasto {
    ...
    //1.Atributos
    /**
    *  Se definen los atributos principales de la clase gasto: id, descripcion, fechaRegistro, fechaPago, proveedor, comprobante, gastoConcepto, liquidado, importe
    * */
    private int id;
    ...
    /** 
    * Metodo getId, para obtener el identificador asociado al gasto
    * 
    ...
    **/
    ...
    /** 
    * Metodo getProveedor, para obtener el proveedor asociado al gasto
    * 
    ...
    **/
    ...
    /** 
    * Metodo getDescripcion, para obtener la descripcion asociado al gasto
    * 
    ...
    **/
    ...
    /** 
    * Metodo getComprobante, para obtener el comprobante asociado al gasto
    * 
    ...
    **/
    ...
    /** 
    * Metodo getGastoConcepto, para obtener el gastoConcepto asociado al gasto
    * 
    ...
    **/
    ...
    /** 
    * Metodo getFechaRegistro, para obtener la fecha de registro asociado al gasto
    * 
    ...
    **/
    ...
    /** 
    * Metodo getFechaPago, para obtener la fecha de pago asociado al gasto
    * 
    ...
    **/
    ...
    /** 
    * Metodo getImporte, para obtener el importe asociado al gasto
    * 
    ...
    **/
    ...
    /** 
    * Metodo isLiquidado, para comprobar si el gasto está liquidado
    * 
    * @return liquidado booleano que contiene el estado de liquidación del gasto
    **/
    ...
    /** 
    * Metodo setLiquidado, para establecer el estado de liquidacion del gasto
    * 
    ...
    **/
    ...
    /** 
    * Metodo setGasto, establece la información asociada a un gasto
    * 
    * @param descripcion descripcion del gasto
    * @param fechaRegistro fecha de registro del gasto
    * @param fechaPago fecha de pago del gasto
    ...
    **/
    ...
    /** 
    * Metodo bajaGasto, da de baja a un gasto
    * 
    ...
    **/
    ...
    /** 
    * Metodo updateGasto, actualiza la información asociada a un gasto
    * 
    ...
    **/
    ...
    /** 
    * Metodo toString que muestra los datos correspondientes a un gasto
    * 
    **/
    @Override

...
/**
 *  Clase que gestiona el tipo de gasto GastoConceptoCompuesto, hereda de la clase GastoConcepto
 * */
public class GastoConceptoCompuesto extends GastoConcepto {
    
    //1.Atributos
    /**
    *  Se definen los atributos basicos de la clase: la lista de gastos gastoConcepto 
    * */
    ...
    * */
    ...
    //3.Metodos
    /** 
    * Metodo getGastosConcepto, para obtener el listado de gastos asociados al gasto compuesto
    * 
    * @return gastosConcepto lista compuesta por los gastos asociados a un gasto compuesto
    **/
